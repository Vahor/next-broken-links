...
export default function Home() {
	return (
		<div>
			...
			<img src="https://vahor.fr/something.json" alt="External image pointing to valid file" />
			<img src="https://vahor.fr/invalid-external.png" alt="External image that doesn't exist" />
		</div>
	);
}
